 ...
 * Size: 8 px
 * Bpp: 1
 * Opts: --bpp 1 --size 8 --no-compress --font C:/Users/marke/AppData/Local/Temp/t5/Tiny5.ttf --range 0x20-0x7E --symbols ° --format lvgl -o main/frixos_5.c --force-fast-kern-format
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 199, .adv_w = 64, .box_w = 3, .box_h = 3, .ofs_x = 0, .ofs_y = 2}
};
