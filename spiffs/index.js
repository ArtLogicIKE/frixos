    ...
    document.querySelectorAll('[data-i18n], [data-i18n-placeholder], [data-i18n-aria-label]').forEach(element => {
        ...
        if (!cache) {
            cache = {
                ...
                lastAriaLabelKey: null,
                lastI18nValue: null,
                lastPlaceholderValue: null,
                lastAriaLabelValue: null
            };
        ...
        if (i18nKey) {
            ...
            // Optimization: Only update DOM if content OR key actually changed to avoid layout thrashing
            if (translation && (cache.lastI18nValue !== translation || cache.lastI18nKey !== i18nKey)) {
                element.innerHTML = translation;
                cache.lastI18nValue = translation;
                cache.lastI18nKey = i18nKey;
            }
        }
        ...
        if (placeholderKey) {
            ...
            if (translation && (cache.lastPlaceholderValue !== translation || cache.lastPlaceholderKey !== placeholderKey)) {
                element.placeholder = translation;
                cache.lastPlaceholderValue = translation;
                cache.lastPlaceholderKey = placeholderKey;
            }
        }

        if (ariaLabelKey) {
            const translation = getNestedTranslation(trans, ariaLabelKey);
            if (translation && (cache.lastAriaLabelValue !== translation || cache.lastAriaLabelKey !== ariaLabelKey)) {
                element.setAttribute('aria-label', translation);
                cache.lastAriaLabelValue = translation;
                cache.lastAriaLabelKey = ariaLabelKey;
            }
        }
    });

    // Hoist common translations used in loops
